...
import (
	...
	"saagie.io/provider-mailgun/apis"
	"saagie.io/provider-mailgun/apis/v1alpha1"
	"saagie.io/provider-mailgun/config"
	"saagie.io/provider-mailgun/internal/clients"
	"saagie.io/provider-mailgun/internal/controller"
	"saagie.io/provider-mailgun/internal/features"
)

func main() {
	var (
		app              = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for Mailgun").DefaultEnvars()
